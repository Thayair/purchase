...
if (isset($_POST['submit'])) {
	...
	$catController->createCategory($name);
}
?>
<!DOCTYPE html>
<html lang="en">
...
<div class="col-md-12">
	...
	<div class="row pt-3">
		<div class="col-md-12">
			<div class="form-group">
				...
				<input type="text" id="input1" name="name" class="form-control" style="border-color:skyblue;" >
	...
	<div style="text-align: center;" class="pt-4 pb-3">
		<button type="submit" name="submit" id="show" class="btn-primary p-2" style="text-align: center; border-radius: 5%; border:1px solid green; width: 100px;">Submit
		</button>
	</div>
	</form>
</div>
